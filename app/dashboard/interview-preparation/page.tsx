...
export default function InterviewPreparationPage() {
  ...
  const handleStart = async (e: React.FormEvent) => {
    e.preventDefault();
    await start({ type: "mock_interview", jobRole, jobDescription, answerStyle });
  };
      ...
      <Container maxWidth="sm" sx={{ py: 6, flex: 1 }}>
        <Paper elevation={0} sx={{ p: 4, borderRadius: "20px", border: "1px solid", borderColor: "divider" }}>
          ...
          <Typography variant="body2" color="text.secondary" align="center" sx={{ mb: 3 }}>
            Speak your practice interview question out loud - Kloud Koach AI listens, transcribes, and gives you a
            suggested spoken answer tailored to your active resume.
          </Typography>
      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        {turns.length === 0 && isActive && (
          <Box display="flex" flexDirection="column" alignItems="center" py={8} color="text.secondary">
            ...
            <Typography>Speak your question out loud whenever you&apos;re ready.</Typography>
          </Box>
        )}
      </Container>
    </Box>
