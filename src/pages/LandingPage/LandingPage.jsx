        ...
        <Container maxWidth="lg">
          ...
          {!loading && !error && (
            <Grid container spacing={4} justifyContent="center" alignItems="stretch">
              {plans.filter(plan => plan.isActive === true).map((plan) => {
                    ...
                    >
                      ...
                      <List sx={{ flexGrow: 1, py: 2 }}>
                        {plan.features.filter(feature =>
                          feature.isActive === true && feature.limitValue > 0
                        ).map((feature, i) => (
                          <ListItem key={i} disableGutters>
                            ...
                            <ListItemText
                              ...
                              secondary={
                                (feature.featureType === "TimeBased" && feature.limitValue > 0) ? `${feature.limitValue} ${feature.unit}` :
                                  (feature.featureType === "CountBased" && feature.limitValue > 0) ? `${feature.limitValue} ${feature.unit}` :
                                    (feature.featureType === "TokenBased" && feature.limitValue > 0) ? `${(feature.limitValue / 1000)}k tokens` : null
                              }
                            />
                          </ListItem>
                        ))}
