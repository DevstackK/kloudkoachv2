...
import ModelTrainingIcon from '@mui/icons-material/ModelTraining'; // Icon for Prep
...
const UsageMonitor = () => {
  ...
  return (
    ...
    >
        ...
        <Box mb={2}>
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={0.5}>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Typography variant="body2" fontWeight="medium">Live Interview Co-Pilot Time</Typography>
            </Box>
      ...
      {/* Interview Prep Usage - Added for Pro/Ultra */}
      {interviewPrep && (
        <Box mb={2}>
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={0.5}>
            <Box display="flex" alignItems="center" gap={1}>
              <ModelTrainingIcon fontSize="small" color="action" />
              <Typography variant="body2" fontWeight="medium">Interview Prep Time</Typography>
            </Box>
            <Typography variant="caption" fontWeight="bold">
        ...
        <Box>
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={0.5}>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Typography variant="body2" fontWeight="medium">Resume Uploads</Typography>
            </Box>
            <Typography variant="caption" fontWeight="bold">
              {resumes.limit === -1 
                ? "Unlimited" 
