...
const HomePage = () => {
  return (
    <Container maxWidth="md" sx={{ py: { xs: 4, sm: 8 } }}>
      <Typography variant="h3" component="h1" gutterBottom align="center" sx={{ fontWeight: 'bold', mb: 2, fontSize: { xs: '2.5rem', sm: '3rem' } }}>
        Welcome!
      </Typography>
      ...
      <Grid container spacing={4} justifyContent="center">
        {options.map((option) => (
          <Grid item key={option.title} xs={12} sm={6}>
            ...
            >
              <CardActionArea component={RouterLink} to={option.path}>
